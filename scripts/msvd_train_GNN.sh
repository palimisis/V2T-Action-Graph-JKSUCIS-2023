...
FEATURES_PATH=./extracted_features/msvd/MSVD_Clip4Clip_features.pickle # <CLIP FEATURE FOR Theta_2> # Change into the features you extracted from CLIP4Clip
DATA_GEOMETRIC_PATH=./extracted_features/msvd/FinalGraph.pickl # <GRAPH FEATURE for Theta_1># Change into the path to the graph-based features (can be grid or object-based features)
